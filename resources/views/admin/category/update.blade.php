...
@section('content')
    ...
    <div class="right">
        ...
        <div class="right__content">
            ...
            <form action="{{url('admin/category/'.$lstCategoriesEdit->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="right__inputWrapper">

                    <label for="title" >Tên thể loại</label>
                    <input type="text" placeholder="Tiêu đề" name="title" value="{{$lstCategoriesEdit->title}}">
                    </div>

                    <div class="right__inputWrapper">
                        <label for="desc">Mô tả</label>
                        <textarea name="detail" id="" cols="30" rows="10" placeholder="Mô tả">{{$lstCategoriesEdit->detail}}</textarea>
                    </div>
                    ...
                    <div class="center">
                        <div class="preview">
                            ...
                            src="{{asset('img')}}/{{($lstCategoriesEdit->image)}}"
                        ...
                        <div style="margin-top: 10px" class="form-input">
                            ...
                            <input type="hidden" value="{{($lstCategoriesEdit->image)}}" name="cat_image">
                        </div>
                    </div>
